        ...
        <div className="grid items-center gap-8 md:gap-12 lg:gap-16 md:grid-cols-2">
          ...
          <div className="min-w-0">
            ...
            <BlurText
              ...
              className="mt-6 text-sm leading-relaxed text-gray-400 sm:text-base"
              delay={0.2}
            />
            ...
            <div className="mt-12 flex flex-col gap-3 sm:flex-row sm:gap-4 md:gap-5">
              ...
              <ScrollReveal>
                ...
                >
                  <Image
                    ...
                    width={52}
                    height={52}
                    className="h-[52px] w-[52px] shrink-0 rounded-xl border border-violet-500/20 object-cover"
                  />
              ...
              <ScrollReveal delay={0.1}>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group/badge inline-flex items-center gap-3 rounded-2xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-xl px-3 py-2.5 transition-all duration-300 hover:border-violet-500/30 hover:bg-white/[0.06] hover:shadow-[0_0_30px_rgba(124,58,237,0.15)] sm:gap-4 sm:px-5 sm:py-4"
                >
                  {/* Toptal icon mark */}
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500/20 to-purple-500/10 border border-violet-500/20">
                    <svg viewBox="0 0 21 27" width="18" height="18" xmlns="http://www.w3.org/2000/svg">
                      <path d="m8.11 0 6.71 6.7c.05.05.09.1.15.15l5.85 5.85-9.51 9.46 4.35 4.36-2.91 2.89-6.66-6.66c-.08-.07-.16-.15-.24-.23l-5.85-5.84 9.48-9.43-4.32-4.31zm4.25 10.5c-.09-.02-.18-.02-.26 0-.09.03-.16.07-.32.22l-5.41 5.39c-.16.16-.2.23-.22.31-.03.09-.03.18 0 .26.02.09.07.17.22.32l1.72 1.72c.15.15.22.19.31.22.09.02.17.02.26 0 .09-.03.16-.07.31-.22l5.41-5.39c.16-.15.2-.23.23-.31.02-.09.02-.17 0-.26s-.07-.16-.22-.31l-1.72-1.72c-.15-.16-.23-.2-.31-.23z" fill="#a78bfa"/>
                    </svg>
                  </div>
                  ...
                  <div className="flex flex-col gap-0.5">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex gap-0.5">
                        {[...Array(5)].map((_, i) => (
                          <svg key={i} className="h-3 w-3 text-violet-400" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div className="flex items-center gap-1.5 text-xs text-gray-500">
                      ...
                      <svg viewBox="0 0 108 30" width="50" xmlns="http://www.w3.org/2000/svg">
                        <g clipRule="evenodd" fill="#9ca3af" fillRule="evenodd">
