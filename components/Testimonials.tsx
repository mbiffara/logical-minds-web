  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 50%, rgba(10,10,15,0.2) 0%, rgba(10,10,15,0.5) 50%, rgba(10,10,15,0.85) 100%)",
        }}
      />
      ...
      <div className="relative mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <div ref={badgeRef} className="flex justify-center" style={{ opacity: 0 }}>
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-violet-500/20 bg-violet-500/[0.07] px-4 py-2 shadow-[0_0_20px_rgba(124,58,237,0.1)] backdrop-blur-xl">
            ...
            <span className="text-sm font-medium text-violet-400">{t("closingCta.badge")}</span>
          </div>
        </div>
        ...
        >
          {headlineWords.map((word, i) => (
            <span
              key={i}
              className="word inline-block bg-gradient-to-b from-white via-white to-gray-500 bg-clip-text text-transparent"
              style={{ opacity: 0 }}
            >
              {word}
        ...
        <p
          ref={subtitleRef}
          className="mx-auto mt-8 max-w-3xl text-sm leading-relaxed text-gray-400 sm:text-base md:text-lg"
          style={{ opacity: 0 }}
        >
        ...
        <div ref={ctaRef} className="mt-8" style={{ opacity: 0 }}>
          <button
            onClick={openContact}
            className="group/btn relative cursor-pointer overflow-hidden rounded-full border border-white/[0.1] bg-white/[0.05] backdrop-blur-xl transition-all duration-500 hover:border-violet-500/30 hover:bg-white/[0.08] hover:shadow-[0_8px_40px_rgba(124,58,237,0.12)]"
          >
        ...
        <div ref={noteRef} className="mt-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
          <div className="note-item flex items-center gap-1.5" style={{ opacity: 0 }}>
            <svg className="h-3.5 w-3.5 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
